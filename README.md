A simple To Do List where you can write down your tasks(just double click on column to be create the task) and drag them to the other column according to the progress of your task. 
